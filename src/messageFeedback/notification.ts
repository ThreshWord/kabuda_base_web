...
export class Notification {
  ...
  async warning(message?: string, title?: string): Promise<boolean> {
    ...
    return this.show(feedBackType.WARNING)
  }
  ...
  async success(message?: string, title?: string): Promise<boolean> {
    return this.setTitleAndMessage(title, message).show(feedBackType.SUCCESS)
  }
  ...
  async info(message?: string, title?: string): Promise<boolean> {
    return this.setTitleAndMessage(title, message).show(feedBackType.INFO)
  }
  ...
  async error(message?: string, title?: string): Promise<boolean> {
    return this.setTitleAndMessage(title, message).show(feedBackType.ERROR)
  }
   ...
   * @see info()
   */
  private async show(type: feedBackType): Promise<boolean> {
